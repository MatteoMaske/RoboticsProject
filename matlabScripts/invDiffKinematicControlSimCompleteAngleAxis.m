...
% Dt: delta time
function [TH] = invDiffKinematicControlSimCompleteAngleAxis(direct, Jac, xd, phid, TH0, Kp, Kphi, minT, maxT, Dt)
    ...
    for t = T(2:L),
        ...
        dotqk = invDiffKinematiControlCompleteAngleAxis(Jac,qk, xe, xd(t), vd, Re, phid(t),phiddot, Kp, Kphi);
        qk1 = qk + dotqk'*Dt;
         q = [q; qk1];
        qk = qk1;
    end
