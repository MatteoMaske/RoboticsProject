...
% Dt: delta time
function [TH] = invDiffKinematicControlSimRedundancy(direct, Jac, xd, qdot0, TH0, K, minT, maxT, Dt)
    ...
    for t = T(2:L),
        [xe, lost]  = direct(qk);
        vd = (xd(t)-xd(t-Dt))/Dt;
        dotqk = invDiffKinematiControlRedundancy(Jac,qk, xe, xd(t),  vd, qdot0(qk)', K);
        qk1 = qk + dotqk'*Dt;
        q = [q; qk1];
        qk = qk1;
    end
